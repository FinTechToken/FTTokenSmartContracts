...
contract Tutorial { 
// ReWrite The Entire Contract -
// Because the blockchain is the server - this contract is to update state of tutorial here
    ...
    string public name = "FreeToken"; // ERC20 Optional
    ...
    function Tutorial() public{ //Constructor
